...
## Step 1:
 ...
 showing different different website
 choose :
 https://onepagelove.com/templates/html-templates

## Step 3:

 Copy all codes in index.html file
 and pass in angular project index.html file (overwrite every code except 
  <base href="/"> after <title>MyWeb</title> )
 ```
 <!DOCTYPE html>
<html lang="en">
  <head>
 ...
 ## Step 4:
 Run angular project and see content will be display but css not work
 
 ## Step 5:
 Now copy the css from template locations like 
  <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css" >
  and past to the  styles.css file in angular project
...
[More](https://angular.io/api/common/APP_BASE_HREF)
